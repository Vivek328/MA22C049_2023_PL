# -*- coding: utf-8 -*-
"""Genome of SARS- CoV-2.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1z0gHwkmFbE9YjHWf368t3jCykSZU5h2a
"""
...
s=orf7a.replace('u', 'T').replace('a', 'A').replace('g', 'G').replace('c',
'C')
s
